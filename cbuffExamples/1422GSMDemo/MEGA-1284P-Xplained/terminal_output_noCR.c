...
const CBUFF     termLine1[]  = 
           "CBUFF Demo for Explorer 16/PIC24F - 1422GSM - MASTERs 2010\r\r";
const CBUFF     termLine3a[] = "testBuffer Object Fill: ";
const CBUFF     termLine3c[] = " from 50 bytes.    \r";

const CBUFF     termLine4a[] = "[";
const CBUFF     termLine4c[] = "] - ";
const CBUFF     termLine4e[] = "%  \r\r";

const CBUFF     termLine6a[] = "Fill rate : ";
const CBUFF     termLine6c[] = " bytes/second     \r\r";

const CBUFF     termLine8a[] = "Empty buffer: ";
const CBUFF     termLine8b[] = "Manually";
const CBUFF     termLine8c[] = " / ";
const CBUFF     termLine8d[] = "Automatically";

const CBUFF     termLine9a[] = "Buffer empty trigger: ";
const CBUFF     termLine9c[] = " bytes\r\r";
const CBUFF     termLine9d[] = "                               \r\r";

const CBUFF     termLine11[] = "Last buffer content:\r";

const CBUFF     termLine12a[]   = "{";
const CBUFF     termLine12c[]   = "}\r";
